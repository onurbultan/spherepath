...
export { confirmVoiceNote, discardVoiceNote, getLatestReviewableVoiceNote, getVoiceNote, processVoiceNote, registerInteractionText, registerVoiceNote, registerVoiceTextTest } from "./voice/voice-api.js";
