...
const isOwnerOpportunity = (type: OpportunityType) => type === "seller_listing" || type === "landlord_listing";
...
export function OpportunitiesView() {
  ...
  const lostCount = opportunities.filter((item) => item.stage === "lost").length;
  ...
  function recordActionSummary(opportunity: OpportunityRecord): string {
    ...
    if (opportunity.stage === "lost") return "Kayıt kapatıldı";
