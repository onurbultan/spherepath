...
export function OpportunitiesView() {
  ...
  const duplicateOpportunity = selectedContactId
    ? opportunities.find((item) => item.subjectContactId === selectedContactId && item.type === type && activeStages.includes(item.stage))
    : undefined;
