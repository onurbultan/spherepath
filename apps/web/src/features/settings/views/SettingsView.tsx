...
export function SettingsView() {
  ...
  return <AppShell>
    <header className="page-header settings-header"><div><p className="eyebrow">ÇALIŞMA ALANI</p><h1>Ayarlar ve uyum</h1><p className="context-sentence">Profil, ofis yükümlülükleri, hatırlatmalar ve veri sahibi talepleri.</p></div><button className="secondary-action inline-action" type="button" onClick={() => void signOut()}><LogOut size={17} /> Oturumu kapat</button></header>
