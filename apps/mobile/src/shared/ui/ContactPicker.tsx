...
import { controlMetrics } from "./SpField";
...
const styles = StyleSheet.create({ root: { gap: space.sm }, inputRow: { minHeight: 48, borderWidth: StyleSheet.hairlineWidth, borderRadius: radius.md, paddingHorizontal: space.md, flexDirection: "row", alignItems: "center", gap: space.sm }, input: { flex: 1, minHeight: controlMetrics.minHeight, fontFamily: controlMetrics.fontFamily, fontSize: controlMetrics.fontSize }, options: { gap: space.xs }, option: { minHeight: 42, borderWidth: StyleSheet.hairlineWidth, borderRadius: radius.sm, justifyContent: "center", paddingHorizontal: space.md } });
