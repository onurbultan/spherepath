import { createCommandId, type CallRecordView, type Contact, type ContactDraft, type ContactPrivacyDraft, type Interaction, type InteractionEdit } from "@spherepath/shared";
