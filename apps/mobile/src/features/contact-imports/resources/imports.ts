...
export function beginGoogleImport(uid: string) { return apiClient.command<{ platform: string }, { jobId: string; authorizationUrl: string }>("beginGoogleContactImport", { platform: "mobile" }, createCommandId(uid)); }
