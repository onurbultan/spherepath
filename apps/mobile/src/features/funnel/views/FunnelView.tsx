...
export default function FunnelView() {
  ...
  const counts = query.data?.counts; const earnings = query.data?.earnings; const target = query.data?.target;
  const stages = counts ? [
