...
Current product boundaries and the infrastructure required for provider integrations are tracked in
[`docs/PRODUCT_LIMITS_AND_NEXT_INFRA.md`](docs/PRODUCT_LIMITS_AND_NEXT_INFRA.md).
