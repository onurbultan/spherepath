...
export const apiQueryKeys = {
  contactImports: ["contact-imports"] as const,
  contactImport: (jobId: string) => ["contact-imports", jobId] as const,
  ...
  contributions: (contactId: string) => ["contacts", contactId, "contributions"] as const,
  ...
  portfolioMatches: ["portfolio-matches"] as const,
  matchNotifications: ["portfolio-match-notifications"] as const,
